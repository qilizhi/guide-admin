...
public class GuideLineTripController {
	 ...
	 */
	@RequestMapping()
	public String list(@RequestParam String lineNo, GuideLineTrip guideLineTrip,Model model){
		try {
	...
	public String add(GuideLineTripModel guideLineTripModel , @RequestParam(value="lineNo") String lineNo,Model model){
		try {
			...
			//价格
			List<GuideLineDatePrice> lsGuideLineDatePrices = guideLineDatePriceService.getGuideLineDatePriceByLineNo(lineNo);
