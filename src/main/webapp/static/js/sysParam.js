...
var _ActInfo=function(){
	...
	var addUrl = mlx.ctx + "/admin/sysParam/create";
	var updateUrl = mlx.ctx + "/admin/sysParam/update";
	var delUrl = mlx.ctx + "/admin/sysParam/delete";
	var batdelUrl = mlx.ctx + "/admin/sysParam/deletes";
	var getUrl = mlx.ctx + "/admin/sysParam";
