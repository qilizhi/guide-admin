...
var GuideService=function(){
	...
	var delUrl=mlx.ctx+"/admin/guideService/delete";
	var auditUrl=mlx.ctx+"/admin/guideService/audit"
	var onOffUrl=mlx.ctx+"/admin/guideService/onOff"
