							...
							<div class="tab-content">
								...
								<div class="portlet-body">
									...
									<form action="${ctx }/guideAdmin/trip/save" id=form_sample_3
										onsubmit="return validForm();" class="form-horizontal"
										...
										<div class="form-body">
											...
											<input type="hidden" name="lineNo" value="${lineNo}" /> <input
																...
																<c:forEach var="i" begin="1" end="${guideLine.totalDay}">
																	<tr style="border-bottom: 1px solid #ccc;">
																		<td>${guideLine.lineNo}<input type="hidden"
																			name="guideLineTrips[${i-1}].id" value="" /> <input
																			type="hidden" name="guideLineTrips[${i-1}].lineNo"
																		...
																		<td><textarea type="text"
																				name="guideLineTrips[${i-1}].address" id="address">  </textarea></td>
																		<td><textarea type="text"
																				name="guideLineTrips[${i-1}].traffic" id="traffic"> </textarea></td>
																		<td><textarea type="text"
											...
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													<a class="btn btn-primary btn-sm btn-success"
														href="${ctx}/guideAdmin/line/backToPrice/${lineNo}?startDate=${startDate}&endDate=${endDate}"
														id="btn-save">上一步</a>
