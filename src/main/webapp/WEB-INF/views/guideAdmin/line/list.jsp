...
<body>
	...
	<div class="row">
		...
		<input type="text" class="form-filter input-sm" placeholder="线路标题" name="title" value="${title}">	
		<input type="text" class="form-filter input-sm" placeholder="线路编号" name="lineNo" value="${lineNo}">		
	...
	<div id="detailResponsive"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="${ctx}/guideAdmin/line/upAndDown" id="modalForm" class="form-horizontal">
			 ...
			 $.ajax({
		    	...
		    	success:function(data){
		    		...
		    		if(data.result.auditStatus==2){
		    			...
		    			comm.showMsg('warning', '消息提示', '该线路通过未审核，暂不能上线！');
		    		}
		    	},error:function(){
