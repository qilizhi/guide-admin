		...
		<div class="col-md-12">
			...
			<div class="portlet light portlet-fit bordered">
				...
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-cogs"></i><span
							class="caption-subject font-dark bold uppercase">红包记录</span>
					</div>
					<div class="actions">
				...
				<div class="portlet-body">
					...
					<form id="searchForm" action="${ctx}/guideAdmin/actRedPacket/list"
						method="post">
						<div class="row">
								...
								<c:forEach items="${list}" var="item" varStatus="index">
									<tr role="row" >
										...
										<%-- <td><fmt:formatDate value="${item.createTime}"
												pattern="yyyy-MM-dd HH:mm:ss" /></td> --%>
										<td>
											<a href="${ctx}/guideAdmin/actRedPacket/${item.id}"
											title="详情" class="btn blue btn-sm btn-outline"">详情</a> <%-- 
											<a href="javascript:detailShow(${item.id})"
											title="详情" class="btn blue btn-sm btn-outline"">详情</a>
											<a class="btn yellow btn-sm btn-outline"
...
<script type="text/javascript">
		...
		var getUrl = mlx.ctx + "/guideAdmin/actRedPacket";
