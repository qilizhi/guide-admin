            ...
            <input type="hidden" name="id" value="${guideStrategy.id }"/>
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="title" data-required="1" class="form-control" value="${guideStrategy.title }"/> </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">攻略描述
                            <span class="required"> * </span>
                        </label>
                        <div class="col-md-4">
                        	<textarea class="form-control textarea" id="buyNotice" name="description" maxlength="1800" rows="8" cols="20" data-name="buyNotice" >${guideStrategy.description }</textarea></div>
                    </div>
                    <%-- <div class="form-group">
                    ...
                    <div class="form-group last">
                        ...
                        <div class="col-md-9">
                            <script id="editor" type="text/plain" name="content"
								style="width:800px;height:500px;">${guideStrategy.content }</script>
		...
		$imgUpload.fileupload({
					...
					progressall : function(e, data) {
						...
						if (data.result.code == "200") {
							...
							$("a.grouped_elements").attr("href",data.result.result[0].filePath);//fancyBox取值
							$loadName.html("重传");
						} else {
