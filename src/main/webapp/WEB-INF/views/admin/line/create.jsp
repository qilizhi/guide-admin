		...
		<div class="col-md-12">
			...
			<div class="portlet light portlet-fit portlet-form ">
				...
				<div class="portlet-body">
					<!-- BEGIN FORM -->
					<form action="${ctx }/admin/line/add" id=form_sample_3
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-2 line-img">
										...
										<input type="hidden" name="imgUrl"
											value="${guideLine.imgUrl }" /> <img id="image" alt=""
								...
								<div class="form-group last">
									<label class="control-label col-md-3">攻略内容 <span
										class="required"> * </span>
									</label>
									<div class="col-md-9">
										<script id="editor" type="text/plain" name="content"
											style="width:600px;hight:1000px;"></script>
									</div>
								</div>
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-3 col-md-9">
									...
									<!-- 修改按钮 -->
									<a href="javascript:void();" onClick="javascript:history.back(-1);"
