		...
		<div class="col-md-12">
			...
			<div class="portlet light portlet-fit bordered">
				...
				<div class="portlet-body">
					<form id="searchForm" action="${ctx}/admin/sysLoginLog" method="get">
						<div class="row">
							...
							<div class="col-md-4" style="text-align: right;">
								<input type="text" class="form-filter input-sm"
									placeholder="登录名" name="userName" value="${sysLoginLog.userName}">
								<input type="text" class="form-filter input-sm"
									placeholder="登录IP" name="loginIp" value="${sysLoginLog.loginIp}">
								<button type="submit"
							...
							<tbody>
								...
								<c:forEach items="${list}" var="item" varStatus="index">
									<tr role="row" >
										...
										<td>${item.userName}</td>
										<td>
										<fmt:formatDate value="${item.loginTime}" pattern="yyy-MM-dd hh:mm:ss"/>
										</td>
