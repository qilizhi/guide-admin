...
<body>
		...
		<div class="col-md-12">
			...
			<div class="portlet light portlet-fit bordered">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-cogs"></i><span
							class="caption-subject font-dark bold uppercase">参数设置列表</span>
					</div>
						<div class="actions">
				...
				<div class="portlet-body">
					<form id="searchForm" action="${ctx}/admin/sysParam" method="get">
						<div class="row">
							...
							<div class="col-md-4" style="text-align: right;">
								<input type="text" class="form-filter input-sm"
									placeholder="参数名" name="paramName" value="${sysParam.paramName}">
								<button type="submit"
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<c:forEach items="${list}" var="item" varStatus="index">
									<tr  >
										 <td style="padding-left: 8px;text-align: center;"><input type="checkbox" id="${item.id}" class="icheck" /></td>
						...
						<div class="portlet-body">
							...
							<div class="form-body">
								...
								<div class="form-group  margin-top-20">
									<label class="control-label col-md-3">参数名 <span
										class="required"> * </span>
									</label>
									<div class="col-md-4">
								...
								<div class="form-group">
									<label class="control-label col-md-3">参数类型 <span
										class="required"> * </span>
									</label>
									<div class="col-md-6">
										<div class="input-icon right">
											<i class="fa"></i> <input type="text" class="form-control"
												name="paramType" placeholder="" />  
										</div>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3">参数key <span
										class="required"> * </span>
									</label>
									<div class="col-md-6">
										<div class="input-icon right">
								...
								<div class="form-group">
									<label class="control-label col-md-3">参数值 <span
										class="required"> * </span>
									</label>
									<div class="col-md-6">
										<div class="input-icon right">
					...
					<div class="modal-header">
						<div class="portlet-body">
							...
							<div class="form-body">
								...
								<div class="form-group  margin-top-20">
									<label class="control-label col-md-6">参数名: </label>
									<div class="col-md-6">
										<label class="control-label"><span id="paramName">
										</span> </label>
								...
								<div class="form-group  margin-top-20">
									<label class="control-label col-md-6">参数类型: </label>
									<div class="col-md-6">
										<label class="control-label"><span id="paramType">
										</span> </label>

									</div>
								</div>
								<div class="form-group  margin-top-20">
									<label class="control-label col-md-6">参数key: </label>
									<div class="col-md-6">
										<label class="control-label"><span id="paramKey">
										</span> </label>

									</div>
								</div>
								<div class="form-group  margin-top-20">
									<label class="control-label col-md-6">参数值: </label>
									<div class="col-md-6">
										<label class="control-label"><span id="paramValue">
										</span> </label>
	...
	<script type="text/javascript" src="${ctx}/static/js/sysParam.js"></script>
