    ...
    <div class="portlet light portlet-fit portlet-form ">
        ...
        <div class="col-xs-12 ">
                            <div class="portlet light bordered">
                              ...
                              <!--右边表单  -->
                              <div class="col-xs-12" >
                              <form:form action="${ctx}/admin/orderRefund/audit"  id="inputForm"  modelAttribute="orderRefundModel">
                                
                                <div class="form-group form-md-line-input">
										<label class="col-lg-3 row control-label text-right mr10"><span style="color:red">*</span>审核状态:</label>
										<div class="col-lg-5">
										<label for="checkStatus1"><form:radiobutton path="checkStatus" value="1"/>通过</label>
										<label for="checkStatus2" style="margin-left:50px;"><form:radiobutton path="checkStatus" value="-1" />不通过</label>
										</div>
									</div>
                                
                                
                                 <div class="form-group form-md-line-input " id="amount_input">
										<label class="col-lg-3 row control-label text-right mr10"><span style="color:red">*</span>退款金额</label>
										<div class="col-lg-5">
										<form:input path="amount" class="form-control" placeholder="退款金额" required="required"/>
											
											<div class="form-control-focus"></div>
										</div>
									</div>
                              <div class="form-group form-md-line-input " id="remark_input">
									<label class="col-lg-3 control-label row text-right mr10">不通过原因：</label>
									<div class="col-lg-5">
									<form:textarea path="remark" class="form-control"  rows="3" placeholder="审核不通过原因"/>
                                 ...
                                 <div class="text-center col-xs-12"><a  class="btn default  mt10 mr10"    href="javascript:history.go(-1);">提交</a><a  class="btn default  mt10 "    href="javascript:history.go(-1);">返回</a></div>
