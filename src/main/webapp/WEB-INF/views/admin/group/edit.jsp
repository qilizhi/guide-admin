...
<div class="portlet light portlet-fit portlet-form ">
	...
	<form action="${ctx}/admin/group/add" id="inputForm" method="post"
		...
		<input type="hidden"  name="emGid" value="${group.emGid}" />
		<div class="form-group form-md-line-input">
			<label class="col-lg-3 control-label">群名称：</label>
			<div class="col-lg-5">
				<input type="text" class="form-control " name="emGname" value="${group.emGname}" />
		...
		<div class="form-group form-md-line-input">
			...
			<div class="col-lg-5">
				<select name="type" class="bs-select form-control ">
					<option value=0
					 <c:if test="${group.type==0}">selected</c:if>  >玩家群</option>
					<option value=1
					<c:if test="${group.type==1}">selected</c:if>
					>明星群</option>
				</select>
			</div>
		</div>
		<div class="form-group form-md-line-input">
			...
			<div class="col-lg-5">
				<!-- <input type="text" class="form-control " name="emGuser" /> -->
                 <input type="hidden" id="emGuser" value="${group.emGuser}">
				<select class="selectpicker" name="emGuser" data-live-search="true" value="${grop.emGuser}">
		...
		<div class="form-group form-md-line-input">
			...
			<div class="col-lg-5">
				<input type="text" class="form-control " name="emGdesc" value="${group.emGdesc}" />
				<div class="form-control-focus"></div>
			</div>
		</div>
		<div class="form-group form-md-line-input">
			...
			<div class="col-lg-5">
				<div class="col-lg-7" id="supprogress">
					<input type="hidden" name="image" value="${group.image}" /> <span id="imageName"></span>
					<div class="progress">
				...
				<div class="col-lg-2">
					<img id="image" name="imgUrl" alt="" src="${group.image}"> <span
		...
		<div class="form-group form-md-line-input">
			...
			<div class="col-lg-5">
				<input type="text" class="form-control " name="emMaxusers" value="${group.emMaxusers}" />
				<div class="form-control-focus"></div>
			</div>
		</div>
		<div class="form-group form-md-line-input">
			...
			<div class="col-lg-5">
				<select name="emPublic" class="bs-select form-control ">
					<option value=0 
					<c:if test="${group.emPublic==0}">selected</c:if>
					>不公开</option>
					<option value=1
					<c:if test="${group.emPublic==1}">selected</c:if>
					>公开</option>
				</select>
				<div class="form-control-focus"></div>
			</div>
		...
		<div class="form-group form-md-line-input">
			...
			<div class="col-lg-5">
				<select name="emAllowinvites" class="bs-select form-control ">
					<option value=0
					<c:if test="${group.emAllowinvites==0}">selected</c:if>
					>不需要</option>
					<option value=1
					<c:if test="${group.emAllowinvites==1}">selected</c:if>
					>需要</option>
				</select>
				<div class="form-control-focus"></div>
			</div>
		...
		<div class="form-group form-md-line-input">
			...
			<div class="col-lg-5">
				<input type="text" class="form-control " name="enterRule"  value="${group.enterRule }" />
			</div>
		</div>
		<div class="form-group form-md-line-input">
	...
	<script type="text/javascript">
		$(function() {
			EmGroup.formInit(mlx.ctx+"/admin/group/edit");
