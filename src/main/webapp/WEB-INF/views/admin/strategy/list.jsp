...
<body>
	...
	<div class="note note-success">
		<p>
			温馨提示<br />1.查询导游的攻略信息,请点击<a class="btn red btn-outline"
				href="${ctx}/admin/guideUserInfo" target="_blank">导游用户</a>
		</p>
	</div>
				...
				<div class="portlet-body">
						...
						<div class="row">
							...
							<div class="col-md-6" style="text-align: right;">
								<input type="text" class="form-filter input-sm"
									placeholder="攻略标题" name="title" value="${title}">
								<button type="submit"
					...
					<div class="table-scrollable">
						<table id="strategy"
							...
							<thead>
								<tr>
									<!-- <th scope="col" colspan="2"><input type="checkbox"
								...
								<c:forEach items="${list}" var="item">
									...
									<%--  <tr class="child">
										<td class="child" colspan="10">
											<ul>
												<li><span class="dtr-title">描述:</span> <span
													class="dtr-data">${item.description}</span></li>
												<li><span class="dtr-title">推荐理由:</span> <span
													class="dtr-data">${item.recommendInfo}</span></li>
											</ul>
										</td>
									</tr>  --%>
								</c:forEach>
	...
	<script type="text/javascript" src="${ctx}/static/js/guideStrategy.js"></script>
</body>
</html>