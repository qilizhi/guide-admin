	...
	<div class="row">
			...
			<div class="portlet box red">
				<div class="portlet-title">
					...
					<!-- <ul class="nav nav-tabs">
						...
						<li class="active"><a href="${ctx}/admin/guideTuan/cancel" >已取消</a></li>
					</ul>
				</div>
		...
		<%-- 				<div class="tab-pane active" id="portlet_tab_1">
						...
						<div class="tab-pane active" id="portlet_tab_3">
							<div class="portlet-body">
								<form id="searchForm" action="${ctx}/admin/guideTuan/cancel"
									method="post">
									<div class="row">
										<div class="col-md-4">
										...
										<div class="col-md-8" style="text-align: right;">
											...
											<input type="text" class="form-filter input-sm"
												placeholder="出团编号" name="tuanNo" value="${lineNo}">
											<input type="text" class="form-filter input-sm"
