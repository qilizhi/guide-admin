						...
						<ul class="nav navbar-nav">
							<li class="dropdown dropdown-fw  active selected ${homeclass}"><a
								...
								<ul class="dropdown-menu dropdown-menu-fw">
									...
									<li class="${myStory_class}"><a href="${ctx}/guideAdmin/myStory">我的故事
									</a></li>
									<li class="${aboutMe_class} "><a href="${ctx}/guideAdmin/aboutMe">基本资料
									</a></li>
									<li class="${tuan_class}"><a href="${ctx}/guideAdmin/tuan">出团列表
									</a></li>
									<li class="${pre_class}"><a href="${ctx}/guideAdmin/preView">预览
									</a></li>		
								</ul></li>
							<li class="dropdown dropdown-fw ${guide_orderclass}"><a href="${ctx }/guideAdmin/guideOrder"
								class="text-uppercase"> <i class="icon-basket"></i> 订单
							</a></li>
							
								<li class="dropdown dropdown-fw ${guide_lineclass}"><a href="${ctx }/guideAdmin/line/list"
								class="text-uppercase"> <i class="icon-puzzle"></i> 线路
							</a></li>
								
								<li class="dropdown dropdown-fw ${guide_strategyclass}"><a href="${ctx }/guideAdmin/strategy/list"
								class="text-uppercase"> <i class="icon-paper-plane"></i> 攻略
							</a></li>
							...
							<li class="dropdown dropdown-fw ${guide_imgclass}"><a href="${ctx }/guideAdmin/imgStorage"
								class="text-uppercase"> <i class="icon-wallet"></i> 图库
							</a></li>
