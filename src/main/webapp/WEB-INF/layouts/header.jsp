<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
     <link rel="shortcut icon" href="http://www.mlxing.com/static/images/favicon.ico" /> 
...
<%--         <link href="${ctx}/static/assets/global/plugins/uniform/css/uniform.default.css" rel="stylesheet" type="text/css" />
     ...
     <%--    <link href="${ctx}/static/assets/global/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
        ...
        <link href="${ctx}/static/assets/layouts/layout5/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="${ctx}/static/assets/layouts/layout5/css/custom.min.css" rel="stylesheet" type="text/css" />
      <link href="${ctx}/static/assets/global/plugins/bootstrap-toastr/toastr.min.css" rel="stylesheet" type="text/css" />
	...
	<%-- 	<link rel="stylesheet" href="${ctx}/static/assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css"> --%>
        ...
        <!-- 多文件上传样式 -->
	<%-- 	<link rel="stylesheet" href="${ctx}/static/assets/global/plugins/jquery-file-upload/css/jquery.fileupload-ui.css">
		<link rel="stylesheet" href="${ctx}/static/assets/global/plugins/jquery-file-upload/css/jquery.fileupload.css"> --%>
        <!--[if lt IE 9]>
...
window.g_basePath = "${ctx}";
        ...
        <script src="${ctx}/static/assets/global/plugins/jquery-1.12.3.min.js" type="text/javascript"></script>
